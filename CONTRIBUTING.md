...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/fsm-compiler
   cd fsm-compiler
   ```
...
```sh
https://github.com/flex-development/fsm-compiler/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/fsm-compiler/discussions/new?category=q-a
